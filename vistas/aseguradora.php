                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Nombre:</label>
                            <input type="hidden" name="idseguradora" id="idseguradora">
                            <input type="text" class="form-control" name="nombreseg" id="nombreseg" maxlength="50" placeholder="Nombre aseguradora" required>
                          </div>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/aseguradora.js"></script>
<?php 
}
ob_end_flush();
?>
