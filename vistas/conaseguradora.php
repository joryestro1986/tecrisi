                    ...
                    <div class="panel-body" style="height: 650px;" id="formularioregistros">
                       ...
                       <div class="form-group col-lg-2 col-md-4 col-sm-4 col-xs-12">
						...
						<div class="form-group col-lg-3 col-md-2 col-sm-6 col-xs-12">
                            ...
                            <input type="text"  align="center" class="form-control" name="aseguradora" id="aseguradora" maxlength="250" placeholder="ASEGURADORA" required>
                          </div>
						    	<div class="form-group col-lg-3 col-md-2 col-sm-6 col-xs-12">
                            <label>ATIENDE:</label>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/conaseguradora.js"></script>
<?php 
}
ob_end_flush();
?>
