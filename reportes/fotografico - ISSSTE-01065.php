...
$pdf->setFont('Arial', 'B', 16);
	...
	$pdf->Ln(5);
		...
		$siniestro="SHCP_P04_ISSSTE-01065 2023";
...
$pdf->Cell(1,0, $pdf->Image($ima12, $pdf->GetX()+1, $pdf->GetY(),95,69),'JPEG');  $pdf->Ln(71);$pdf->Cell(170, 1,utf8_decode(''. $DirecTecrisi), 0, 0, 'C', 0);  $pdf->setFont('Arial', 'b', 12);  $pdf->Cell(0, -1,utf8_decode('Page '.$pdf->PageNo(), ), 0, 1, 'C', 0);  $pdf->setFont('Arial', '', 12);
