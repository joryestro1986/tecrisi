...
function listar()
{
	...
	{
		"lengthMenu": [ 5, 10, 25, 75, 120],//mostramos el menú de registros a revisar
		...
		"ajax":
				{
					url: '../ajax/conaseguradora.php?op=listar',
					type : "get",
					dataType : "json",						
					error: function(e){
...
function guardaryeditar(e)
{
	...
	$.ajax({
		url: "../ajax/conaseguradora.php?op=guardaryeditar",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
{
	$.post("../ajax/conaseguradora.php?op=mostrar",{idmovint : idmovint}, function(data, status)
	{
