...
<html>
  <head>
    ...
    <title> TECRISI | https://comercializadora-tecrisi.com/</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <!-- <a href="index2.html" class="logo"> -->
          ...
          <span class="logo-mini"><b>TEC</b>RISI</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>TECRISI</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      TECRISI SA DE CV
                      <small>www.youtube.com/rubenrosalesl</small>
                    </p>
                  </li>
          ...
          <ul class="sidebar-menu">
            ...
            if ($_SESSION['acceso']==1)
            {
              ...
              <ul class="treeview-menu">
                ...
                <li id="lseguradora"><a href="regimenfiscal.php"><i class="fa fa-circle-o"></i> regimen fiscal</a></li>
            ...
            if ($_SESSION['siniestros']==1)
            {
              echo '<li id="mConsultaV" class="treeview">
              <a href="#">
                <i class="fa fa-bar-chart"></i> <span>Consulta estatus <br> siniestros</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li id="lConsulasV"><a href="siniestrosfechaseguradora.php"><i class="fa fa-circle-o"></i> Consulta Status Siniestro </a></li>                
            ...
            if ($_SESSION['siniestros']==1)
            {
              echo '<li id="mSiniestros" class="treeview">
              <a href="#">
                <i class="fa fa-folder"></i> <span>siniestros</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
			<ul class="treeview-menu">
			...
			<ul class="treeview-menu">
			      <li id="lAseguradora"><a href="aseguradora.php"><i class="fa fa-circle-o"></i> Aseguradora </a></li>
			</ul>
            ...
            {
              echo '<li id="mclientesc" class="treeview">
              <a href="#">
                <i class="fa fa-folder"></i> <span>Consulta estatus </span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
			<ul class="treeview-menu">
			      <li id="lSiniestros"><a href="conaseguradora.php"><i class="fa fa-circle-o"></i> Estatus </a></li>
			</ul>
