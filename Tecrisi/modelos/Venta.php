...
Class Venta
{
	...
	public function ventacabecera($idventa){
		$sql=" SELECT v.idventa,v.idcliente, p.nombre as cliente,p.direccion, p.RFC,p.idregfiscal, p.email,p.telefono,regf.idregfiscal, regf.descregf, v.idusuario,u.nombre as usuario,v.tipo_comprobante,v.serie_comprobante,v.num_comprobante,date(v.fecha_hora) as fecha,v.impuesto,v.total_venta FROM venta v INNER JOIN persona p ON v.idcliente=p.idpersona INNER JOIN usuario u ON v.idusuario=u.idusuario inner join regimenfiscal as regf on p.idregfiscal=regf.idregf  WHERE v.idventa='$idventa'";
		return ejecutarConsulta($sql);
	}
