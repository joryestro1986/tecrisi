...
$pdf->setFont('Arial', 'B', 16);
	...
	$pdf->Ln(5);
		...
		$siniestro="SHCP_P04_ISSSTE-01133 2023";
...
$pdf->Cell(1,0, $pdf->Image($image, $pdf->GetX()+140, $pdf->GetY(),45),'PNG');   $pdf->Ln(8);   $pdf->setFont('Arial', 'B', 13);   $pdf->Cell(100, 3,utf8_decode('SINIESTRO: '. $siniestro), 0, 1, 'C', 0);  
  $pdf->setFont('Arial', '', 9);   $pdf->Ln(8);   $pdf->setFont('Arial', 'b', 12);   $pdf->Cell(200, 1,utf8_decode(''. $asegurado), 0, 1, 'C', 0);   $pdf->Ln(5);   
	   $pdf->setFont('Arial', '', 12);$pdf->Cell(1,0, $pdf->Image($ima1, $pdf->GetX()+1, $pdf->GetY(),95,69),'JPEG');
